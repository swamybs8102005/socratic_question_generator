...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'zeroentropy/shims/${shims.kind}'\` before importing anything else from zeroentropy`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'zeroentropy/shims/${shims.kind}'\` after \`import 'zeroentropy/shims/${exports.kind}'\``);
    }
