...
export declare class Queries extends APIResource {
     ...
     */
    topDocuments(body: QueryTopDocumentsParams, options?: Core.RequestOptions): Core.APIPromise<QueryTopDocumentsResponse>;
    /**
     ...
     */
    topSnippets(body: QueryTopSnippetsParams, options?: Core.RequestOptions): Core.APIPromise<QueryTopSnippetsResponse>;
}
export interface QueryTopDocumentsResponse {
    results: Array<QueryTopDocumentsResponse.Result>;
}
export declare namespace QueryTopDocumentsResponse {
    interface Result {
        /**
...
export declare namespace QueryTopPagesResponse {
    /**
     * A Page's metadata.
     */
    interface Result {
...
export declare namespace QueryTopSnippetsResponse {
