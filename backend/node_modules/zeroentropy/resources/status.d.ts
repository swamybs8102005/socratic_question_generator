...
export declare class Status extends APIResource {
     ...
     */
    getStatus(body?: StatusGetStatusParams, options?: Core.RequestOptions): Core.APIPromise<StatusGetStatusResponse>;
...
export declare namespace Status {
    export { type StatusGetStatusResponse as StatusGetStatusResponse, type StatusGetStatusParams as StatusGetStatusParams, };
}
