...
import { GetDocumentInfoListCursor, type GetDocumentInfoListCursorParams } from "../pagination.js";
export declare class Documents extends APIResource {
     ...
     */
    getInfo(body: DocumentGetInfoParams, options?: Core.RequestOptions): Core.APIPromise<DocumentGetInfoResponse>;
    /**
     ...
     * or the document path does not exist within the provided collection.
     */
    getInfoList(body: DocumentGetInfoListParams, options?: Core.RequestOptions): Core.PagePromise<DocumentGetInfoListResponsesGetDocumentInfoListCursor, DocumentGetInfoListResponse>;
    /**
     ...
     * or the document path does not exist within the provided collection.
     */
    getPageInfo(body: DocumentGetPageInfoParams, options?: Core.RequestOptions): Core.APIPromise<DocumentGetPageInfoResponse>;
}
export declare class DocumentGetInfoListResponsesGetDocumentInfoListCursor extends GetDocumentInfoListCursor<DocumentGetInfoListResponse> {
}
...
export declare namespace DocumentGetInfoResponse {
    interface Document {
        id: string;
         ...
         */
        file_url: string;
        index_status: 'not_parsed' | 'parsing' | 'not_indexed' | 'indexing' | 'indexed' | 'parsing_failed' | 'indexing_failed';
        metadata: {
...
export declare namespace DocumentGetPageInfoResponse {
    interface Page {
        id: string;
        /**
...
export interface DocumentAddParams {
     ...
     */
    content: DocumentAddParams.APITextDocument | DocumentAddParams.APITextPagesDocument | DocumentAddParams.APIBinaryDocument;
    /**
...
export declare namespace DocumentAddParams {
    interface APITextDocument {
        /**
    ...
    interface APITextPagesDocument {
        /**
