...
export declare class Collections extends APIResource {
     ...
     * does not exist.
     */
    delete(body: CollectionDeleteParams, options?: Core.RequestOptions): Core.APIPromise<CollectionDeleteResponse>;
    /**
     * Adds a collection.
     *
     ...
     */
    getList(body?: CollectionGetListParams | null | undefined, options?: Core.RequestOptions): Core.APIPromise<CollectionGetListResponse>;
}
